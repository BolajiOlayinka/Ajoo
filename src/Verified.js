    ...
    <div>
      <div className="verifiedBanner">
        <div className="verifiedBannerBody">
          ...
          <p>
            Ajoo takes an additional step to verify the organisations that sign
            up on the platform and makes them stand out from others.
          </p>
        </div>
          ...
          <Row>
            <Col lg="6" md="6" sm="12" xs="12">
              ...
              <p className="verifyPara">
                ...
                elementum sed pellentesque,
              </p>
            </Col>
            <Col lg="6" md="6" sm="12 mt-2" xs="12 mt-2">
